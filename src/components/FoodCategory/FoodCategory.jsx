...
const FoodCategory = () => {
    return (
        <div className='py-5'>
             ...
             <div className='row row-cols-2 row-cols-md-5 gap-0'>
             <div>
                <img src={appetizers} alt="" srcset="" style={{height:"180px", width:"180px"}} className='rounded-circle' />
                <h4 className='text-center my-3 text-muted'>Appetizers</h4>
             </div>
             <div>
                <img src={beef} alt="" srcset="" style={{height:"180px", width:"180px"}} className='rounded-circle' />
             ...
             <div>
                <img src={Vegetarian} alt="" srcset="" style={{height:"180px", width:"180px"}} className='rounded-circle' />
                <h4 className='text-center my-3 text-muted'>Vegetarian</h4>
             </div>
             <div>
                <img src={dessert} alt="" srcset="" style={{height:"180px", width:"180px"}} className='rounded-circle' />
